...
public abstract class AbstractSalesOrderService implements SalesOrderService {
	...
	@Override
	public String updateStatus(String salesOrderId, String lifecyleStatus, String note) {
	...
	public String getShipmentModeFromLogistics(String shippedFrom, String shippedTo, String note) {
		logger.info("applying resilience patterns before calling the logistics-service");
		return resilienceHandler.applyResiliencePatternsForLogisticsService(shippedFrom, shippedTo, note);
	}
	...
	@Override
	public String getShipmentModeForLocal(String shippedFrom, String shippedTo, String note) {

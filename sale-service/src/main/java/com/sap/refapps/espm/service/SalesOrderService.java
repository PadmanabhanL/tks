...
public interface SalesOrderService {
	 ...
	 * @param tax
	 */
	String updateStatus(String salesOrderId, String lifecyleStatus, String note);

	String getLogisticsServiceUri();

	String getShipmentMode(String shippedFrom, String shippedTo, String note);

	String getShipmentModeForLocal(String shippedFrom, String shippedTo, String note);

	String getFinalShipmentMode(String shippedFrom, String shippedTo, String note);
}

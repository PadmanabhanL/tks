...
public class CloudSalesOrderService extends AbstractSalesOrderService {
	...
	private final String logisticsEndpointSuffix = "/api/v1/shipmentmode";

	private final static String TAX_DESTINATION_NAME = "tax";

	private final static String LOGISTICS_DESTINATION_NAME = "logistics";
	...
	public String getLogisticsServiceUri() {
		String logisticsUrl = getUrlFromDestinationService(LOGISTICS_DESTINATION_NAME) + logisticsEndpointSuffix;
		logger.info("***********Logistics microservice endpoint is {}********", logisticsUrl);
		return logisticsUrl;
	}

	@Override
	public String getShipmentMode(String shippedFrom, String shippedTo, String note) {
		logger.info("Cloud SalesOrder Service ---> About to Call Abstract class");
        return getShipmentModeFromLogistics(shippedFrom, shippedTo, note);
	}


	private String getUrlFromDestinationService(String destinationName) {
	...
	private String getTaxUrlFromDestinationService() {
		return getUrlFromDestinationService(TAX_DESTINATION_NAME);
	}
	...
	@Override
	public String getFinalShipmentMode(String shippedFrom, String shippedTo, String note) {
		logger.info("Making REST call to logistics service");
		String logisticsServiceUri = getLogisticsServiceUri();
		logisticsServiceUri = logisticsServiceUri+"?shippedFrom="+shippedFrom+"&shippedTo="+shippedTo;
		logger.info("GENERATED URL:"+logisticsServiceUri);
		URI uri = URI.create(logisticsServiceUri);
